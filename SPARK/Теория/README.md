...
Появился начиная с Spark 0 (Low-Level-API). Используется функциональный API: map, filter, reduce.
...
Появился начиная с Spark 1.3 (Structured API)
...
Появился начиная с Spark 1.6 (Structured API)
