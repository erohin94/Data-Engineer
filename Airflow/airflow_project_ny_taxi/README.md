...
```docker exec <container_id_or_name> pip list``` - если ты не хочю входить в контейнер, можно использовать команду docker exec напрямую из терминала
...
# Заметка - установка S3Hook написать про .env файл
