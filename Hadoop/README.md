...
Есть client, который запрашивает данные из нашего хранилища.

Например, файл, который мы загружали, необходимо забрать. Например его вес 150 Мб и он отправился на хранение в 3 дата ноды.
...
Получение информации о блоках данных: NameNode отвечает клиенту, предоставляя информацию о блоках данных, из которых состоит файл, и их расположение на различных DataNode. В нашем случае это адреса нейм нод и блоки нашего файла. 
