...
`fsck (file system check)` в HDFS — это утилита для проверки состояния файлов и блоков в файловой системе.
Она не чинит файловую систему, а просто показывает диагностику (в отличие от fsck в Linux).
