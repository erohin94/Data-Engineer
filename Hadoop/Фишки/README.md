...
И есть количество взаимодействий `cnt_interactions_calls`, `cnt_interactions_meet`, `cnt_interactions_like` по звонкам встречам и лайкам за отчетную неделю. В данной таблице приведены агрегированные данные для примера.
