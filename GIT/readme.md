...
Перед тем как отправить данные на изменения в общий репозиторий, необходимо сказать гиту, какие именно файлы ты хочешь отправить в GITHUB.
...
Это самая важная команда и постоянно идёт в ногу с командой добавления. 
Данная команда присваивает твоим изменениям идентификатор, по которому можно все твое добро отследить.
